    ...
    <form action="{{ route('packages.update', $package->id) }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-12">
                ...
                <input type="number" name="first_price" class="form-control" value="{{ $package->first_price }}" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-12">
                ...
                <input type="number" name="second_price" class="form-control" value="{{ $package->second_price }}" required>
            </div>
        </div>
