    ...
    <div class="offcanvas offcanvas-end filter-canvas" data-bs-backdrop="static" tabindex="-1" id="filterReport"
        ...
        <div class="offcanvas-body">
            <div class="flex-shrink-0 p-3" style="width: 280px;">
                ...
                <form method="get" action="{{ route('reports.review_filter') }}" class="row g-3 mb-4 mt-2">
                    ...
                    <div class="col-12">
                        <label for="review" class="form-label">Review Type</label>
                        <select name="review" id="review" class="form-select">
                            <option value="all">All Types</option>
                            @foreach (\App\Enums\ReviewTypeEnum::values() as $type)
